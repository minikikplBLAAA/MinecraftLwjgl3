...
public class NetClientHandler extends NetHandler
{
    ...
    {
        EntityPainting entitypainting = new EntityPainting(worldClient, packet25.xPosition, packet25.yPosition, packet25.zPosition, packet25.direction, packet25.title);
    ...
    public void func_6498_a(Packet28 packet28)
    {
        ...
        {
            entity.setVelocity((double)packet28.motionX / 8000D, (double)packet28.motionY / 8000D, (double)packet28.motionZ / 8000D);
            return;
        }
    }
    ...
    public void handleArmAnimation(Packet18ArmAnimation packet18armanimation)
    {
        ...
        if(packet18armanimation.animate == 4)
        {
    ...
    {
        worldClient.func_22143_a(new ChunkCoordinates(packet6spawnposition.xPosition, packet6spawnposition.yPosition, packet6spawnposition.zPosition));
    }
    ...
    {
        Explosion explosion = new Explosion(mc.theWorld, null, packet60.explosionX, packet60.explosionY, packet60.explosionZ, packet60.explosionSize);
    ...
    public void func_20088_a(Packet103 packet103)
    {
        ...
        if(packet103.windowId == 0)
        {
            mc.thePlayer.field_20069_g.func_20119_a(packet103.itemSlot, packet103.myItemStack);
        } else
        if(packet103.windowId == mc.thePlayer.craftingInventory.windowId)
        {
            mc.thePlayer.craftingInventory.func_20119_a(packet103.itemSlot, packet103.myItemStack);
        }
    }
    ...
    public void func_20089_a(Packet106 packet106)
    {
        ...
        if(packet106.windowId == mc.thePlayer.craftingInventory.windowId)
        {
    ...
    public void func_20094_a(Packet104 packet104)
    {
        ...
        {
            mc.thePlayer.field_20069_g.func_20115_a(packet104.itemStack);
        } else
        if(packet104.windowId == mc.thePlayer.craftingInventory.windowId)
        {
            mc.thePlayer.craftingInventory.func_20115_a(packet104.itemStack);
        }
    }
    ...
    public void func_20093_a(Packet130 packet130)
    {
        ...
        {
            TileEntity tileentity = mc.theWorld.getBlockTileEntity(packet130.xPosition, packet130.yPosition, packet130.zPosition);
    ...
    public void handlePlayerInventory(Packet5PlayerInventory packet5playerinventory)
    {
        ...
        if(entity != null)
        {
            entity.func_20045_c(packet5playerinventory.slot, packet5playerinventory.itemID, packet5playerinventory.itemDamage);
        }
    }
    ...
    {
        mc.theWorld.playNoteAt(packet54.xLocation, packet54.yLocation, packet54.zLocation, packet54.instrumentType, packet54.pitch);
    }
