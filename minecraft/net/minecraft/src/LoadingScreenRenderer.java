    ...
    implements IProgressUpdate
{
    ...
    public void func_597_c(String s)
    {
        ...
        } else
        {
            ...
            // <<< ODKOMENTOWANE: To jest konieczne dla GUI >>>
            ...
            // <<< KONIEC ODKOMENTOWANIA >>>
            
            // FIXME: Brakowało swap buffers, żeby wyświetlić to co narysowaliśmy
    ...
    public void setLoadingProgress(int i)
    {
        ...
        // <<< ODKOMENTOWANE: Konieczne dla poprawnego wyświetlania pasków i tła >>>
        GL11.glMatrixMode(5889 /*GL_PROJECTION*/);
        GL11.glLoadIdentity();
