...
public class RenderPlayer extends RenderLiving
{
    ...
    public RenderPlayer()
    {
        ...
        modelBipedMain = (ModelBiped)field_20920_e;
            ...
            float f, float f1)
    {
        ...
        field_208_g.field_1278_i = field_207_h.field_1278_i = modelBipedMain.field_1278_i = itemstack != null;
        field_208_g.field_1277_j = field_207_h.field_1277_j = modelBipedMain.field_1277_j = entityplayer.isSneaking();
        ...
        field_208_g.field_1277_j = field_207_h.field_1277_j = modelBipedMain.field_1277_j = false;
        field_208_g.field_1278_i = field_207_h.field_1278_i = modelBipedMain.field_1278_i = false;
    }
    ...
    protected void func_4015_a(EntityPlayer entityplayer, float f)
    {
        ...
        if(entityplayer.username.equals("deadmau5") && loadDownloadableImageTexture(entityplayer.skinUrl, null))
        {
            for(int i = 0; i < 2; i++)
            {
                ...
                modelBipedMain.func_20095_a(0.0625F);
                GL11.glPopMatrix();
            }
        ...
        if(loadDownloadableImageTexture(entityplayer.field_20067_q, null))
        {
            ...
            GL11.glRotatef(180F, 0.0F, 1.0F, 0.0F);
            modelBipedMain.func_20096_b(0.0625F);
            GL11.glPopMatrix();
        }
    ...
    {
        if(entityplayer.isEntityAlive() && entityplayer.func_22051_K())
        {
