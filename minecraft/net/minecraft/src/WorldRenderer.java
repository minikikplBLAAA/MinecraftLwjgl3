...
public class WorldRenderer
{
    ...
    public void func_1197_a(int i, int j, int k)
    {
        ...
        } else
        {
            ...
            // GL11.glNewList(glRenderList + 2, 4864 /*GL_COMPILE*/); // Deprecated in OpenGL 4.6
            ...
            // GL11.glEndList(); // Deprecated in OpenGL 4.6
            markDirty();
            return;
        }
    }
            ...
            for(int j2 = j; j2 < i1; j2++)
            {
                for(int k2 = k; k2 < j1; k2++)
                {
                    for(int l2 = i; l2 < l; l2++)
                    {
                        ...
                        {
                            flag2 = true;
                            // GL11.glNewList(glRenderList + i2, 4864 /*GL_COMPILE*/); // Deprecated in OpenGL 4.6
                            GL11.glPushMatrix();
                            setupGLTranslation();
                            float f = 1.000001F;
