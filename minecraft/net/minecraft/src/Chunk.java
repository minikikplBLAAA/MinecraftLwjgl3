...
public class Chunk
{
    ...
    public boolean needsSaving(boolean flag)
    {
        ...
        if(hasEntities && worldObj.func_22139_r() >= lastSaveTime + 600L)
        {
            return true;
        }
        return isModified;
    ...
    {
        return new Random(worldObj.func_22138_q() + (long)(xPosition * xPosition * 0x4c1906) + (long)(xPosition * 0x5ac0db) + (long)(zPosition * zPosition) * 0x4307a7L + (long)(zPosition * 0x5f24f) ^ l);
    }
