...
public class GuiCreateWorld extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        field_22134_h = new GuiDisableButton(fontRenderer, width / 2 - 100, 60, 200, 20, stringtranslate.translateKey("selectWorld.newWorld"));
    ...
    private void func_22129_j()
    {
        ...
        for(ISaveFormat isaveformat = mc.func_22004_c(); isaveformat.func_22173_b(field_22132_k) != null; field_22132_k = (new StringBuilder()).append(field_22132_k).append("-").toString()) { }
    }
    ...
    public void drawScreen(int i, int j, float f)
    {
        ...
        drawString(fontRenderer, (new StringBuilder()).append(stringtranslate.translateKey("selectWorld.resultFolder")).append(" ").append(field_22132_k).toString(), width / 2 - 100, 85, 0xa0a0a0);
