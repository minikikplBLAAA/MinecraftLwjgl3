...
public class GuiMainMenu extends GuiScreen
{
    ...
    // FIX: Własna implementacja gluPerspective, aby nie polegać na zewnętrznych bibliotekach
    private void renderPerspective(float fovy, float aspect, float zNear, float zFar) {
    ...
    public void drawScreen(int i, int j, float f)
    {
        ...
        // FIX: Poprawione współrzędne (0, -8) względem translacji
        drawCenteredString(fontRenderer, splashText, 0, -8, 0xffff00);
        
        GL11.glPopMatrix(); 
        // --------------------------

        drawString(fontRenderer, "Minecraft Beta 1.3_01 Ultimate edition", 2, 2, 0x505050);
    ...
    private void drawLogo(float f)
    {
        ...
        // FIX: Używamy własnej metody renderPerspective zamiast GLUHelper/GLU
        renderPerspective(70F, (float)mc.displayWidth / (float)k, 0.05F, 100F);
