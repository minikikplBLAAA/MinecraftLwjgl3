    ...
    implements IBlockAccess
{
    ...
    public World(ISaveHandler isavehandler, String s, WorldProvider worldprovider, long l)
    {
        ...
        field_22145_q = new WorldInfo(l, s);
    ...
    public World(ISaveHandler isavehandler, String s, long l, WorldProvider worldprovider)
    {
        ...
        if(field_22145_q != null && field_22145_q.func_22290_i() == -1)
        {
        ...
        if(flag)
        {
            ...
            field_22145_q.func_22292_a(i, byte0, j);
            field_9430_x = false;
        }
        calculateInitialSkylight();
    }
    ...
    public void setSpawnLocation()
    {
        ...
        int j;
        for(j = field_22145_q.func_22300_e(); getFirstUncoveredBlock(i, j) == 0; j += rand.nextInt(8) - rand.nextInt(8))
        {
    ...
    {
        checkSessionLock();
        field_22147_p.func_22148_a(field_22145_q, playerEntities);
    }
    ...
    {
        return worldProvider.calculateCelestialAngle(field_22145_q.func_22304_f(), f);
    }
    ...
    public void func_22136_c(int i, int j, int k, int l, int i1)
    {
        ...
        if(checkChunksExist(i - byte0, j - byte0, k - byte0, i + byte0, j + byte0, k + byte0))
        {
            if(l > 0)
            {
                nextticklistentry.setScheduledTime((long)i1 + field_22145_q.func_22304_f());
            }
    ...
    public boolean TickUpdates(boolean flag)
    {
        ...
        for(int j = 0; j < i; j++)
        {
            ...
            if(!flag && nextticklistentry.scheduledTime > field_22145_q.func_22304_f())
            {
                break;
            }
