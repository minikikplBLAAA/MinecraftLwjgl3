...
public class PanelCrashReport extends Panel
{
    ...
    public PanelCrashReport(UnexpectedThrowable unexpectedthrowable)
    {
        ...
        try
        {
            ...
            s2 = (new StringBuilder()).append(s2).append("Minecraft: Minecraft Beta 1.3_01 Ultimate edition\n").toString();
            ...
            s2 = (new StringBuilder()).append(s2).append("LWJGL: ").append(org.lwjgl.Version.getVersion()).append("\n").toString();
