...
public class FontRenderer
{
    ...
    public FontRenderer(GameSettings gamesettings, String s, RenderEngine renderengine)
    {
        ...
        // --- Generowanie list wyświetlania dla znaków ---
        for(int i1 = 0; i1 < 256; i1++)
        {
            // ODKOMENTOWANE: W Compatibility Profile to działa idealnie
            ...
            // ODKOMENTOWANE: Przesunięcie kursora po narysowaniu znaku
            GL11.glTranslatef(charWidth[i1], 0.0F, 0.0F);
            GL11.glEndList();
        }

        // --- Generowanie list wyświetlania dla kolorów ---
        for(int j1 = 0; j1 < 32; j1++)
        {
            ...
            // ODKOMENTOWANE: Ustawianie koloru tekstu
    ...
    public void renderString(String s, int i, int j, int k, boolean flag)
    {
        ...
        // ODKOMENTOWANE: Ustawienie koloru i pozycji
        ...
        buffer.flip();
        // ODKOMENTOWANE: Wywołanie listy i przywrócenie macierzy
        GL11.glCallLists(buffer);
        GL11.glPopMatrix();
    }
