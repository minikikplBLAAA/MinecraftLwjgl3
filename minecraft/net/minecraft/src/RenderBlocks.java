...
public class RenderBlocks
{
    ...
    public boolean func_22330_a(Block block, int i, int j, int k, float f, float f1, float f2)
    {
        ...
        field_22338_U = Block.unusedBooleanArray[blockAccess.getBlockId(i + 1, j + 1, k)];
        field_22359_ac = Block.unusedBooleanArray[blockAccess.getBlockId(i + 1, j - 1, k)];
        field_22334_Y = Block.unusedBooleanArray[blockAccess.getBlockId(i + 1, j, k + 1)];
        field_22363_aa = Block.unusedBooleanArray[blockAccess.getBlockId(i + 1, j, k - 1)];
        field_22337_V = Block.unusedBooleanArray[blockAccess.getBlockId(i - 1, j + 1, k)];
        field_22357_ad = Block.unusedBooleanArray[blockAccess.getBlockId(i - 1, j - 1, k)];
        field_22335_X = Block.unusedBooleanArray[blockAccess.getBlockId(i - 1, j, k - 1)];
        field_22333_Z = Block.unusedBooleanArray[blockAccess.getBlockId(i - 1, j, k + 1)];
        field_22336_W = Block.unusedBooleanArray[blockAccess.getBlockId(i, j + 1, k + 1)];
        field_22339_T = Block.unusedBooleanArray[blockAccess.getBlockId(i, j + 1, k - 1)];
        field_22355_ae = Block.unusedBooleanArray[blockAccess.getBlockId(i, j - 1, k + 1)];
        field_22361_ab = Block.unusedBooleanArray[blockAccess.getBlockId(i, j - 1, k - 1)];
