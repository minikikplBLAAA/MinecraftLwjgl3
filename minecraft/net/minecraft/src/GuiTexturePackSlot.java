...
class GuiTexturePackSlot extends GuiSlot
{
    ...
    {
        TexturePackBase texturepackbase = (TexturePackBase)GuiTexturePacks.func_22121_h(field_22265_a).texturePackList.availableTexturePacks().get(i);
        ...
        tessellator.draw();
        field_22265_a.drawString(GuiTexturePacks.func_22127_j(field_22265_a), texturepackbase.texturePackFileName, j + 32 + 2, k + 1, 0xffffff);
        field_22265_a.drawString(GuiTexturePacks.func_22120_k(field_22265_a), texturepackbase.firstDescriptionLine, j + 32 + 2, k + 12, 0x808080);
        field_22265_a.drawString(GuiTexturePacks.func_22125_l(field_22265_a), texturepackbase.secondDescriptionLine, j + 32 + 2, k + 12 + 10, 0x808080);
    }
