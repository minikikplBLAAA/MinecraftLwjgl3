...
public class ClippingHelperImplementation extends ClippingHelper
{
    ...
    private void init()
    {
        ...
        GL11.glGetFloatv(2983 /*GL_PROJECTION_MATRIX*/, projectionMatrixBuffer);
        GL11.glGetFloatv(2982 /*GL_MODELVIEW_MATRIX*/, modelviewMatrixBuffer);
    ...
    private FloatBuffer unusedFloatBuffer;
