...
public abstract class GuiSlot
{
    ...
    public void func_22243_a(int i, int j, float f)
    {
        ...
        int i1 = l + 6;
        if(MouseLwjgl3Helper.isButtonDown(0))
        {
            if(field_22254_k == -1F)
            {
        ...
        GL11.glBindTexture(3553 /*GL_TEXTURE_2D*/, field_22264_a.renderEngine.getTexture("/gui/background.png"));
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        float f1 = 32F;
        tessellator.startDrawingQuads();
        tessellator.setColorOpaque_I(0x202020);
        tessellator.addVertexWithUV(field_22258_g, field_22260_e, 0.0D, (float)field_22258_g / f1, (float)(field_22260_e + (int)field_22252_m) / f1);
        tessellator.addVertexWithUV(field_22259_f, field_22260_e, 0.0D, (float)field_22259_f / f1, (float)(field_22260_e + (int)field_22252_m) / f1);
        tessellator.addVertexWithUV(field_22259_f, field_22261_d, 0.0D, (float)field_22259_f / f1, (float)(field_22261_d + (int)field_22252_m) / f1);
        tessellator.addVertexWithUV(field_22258_g, field_22261_d, 0.0D, (float)field_22258_g / f1, (float)(field_22261_d + (int)field_22252_m) / f1);
        tessellator.draw();
