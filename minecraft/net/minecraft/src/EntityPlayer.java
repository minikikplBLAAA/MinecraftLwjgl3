...
public abstract class EntityPlayer extends EntityLiving
{
    ...
    public EntityPlayer(World world)
    {
        ...
        craftingInventory = field_20069_g;
        yOffset = 1.62F;
        ChunkCoordinates chunkcoordinates = world.func_22137_s();
        setLocationAndAngles((double)chunkcoordinates.field_22395_a + 0.5D, chunkcoordinates.field_22394_b + 1, (double)chunkcoordinates.field_22396_c + 0.5D, 0.0F, 0.0F);
        health = 20;
    ...
    public void readEntityFromNBT(NBTTagCompound nbttagcompound)
    {
        ...
        if(field_21901_a)
        {
            field_21908_b = new ChunkCoordinates(MathHelper.floor_double(posX), MathHelper.floor_double(posY), MathHelper.floor_double(posZ));
            func_22056_a(true, true);
        }
    }
    ...
    public void func_22056_a(boolean flag, boolean flag1)
    {
        ...
        if(chunkcoordinates != null && worldObj.getBlockId(chunkcoordinates.field_22395_a, chunkcoordinates.field_22394_b, chunkcoordinates.field_22396_c) == Block.field_9262_S.blockID)
        {
            BlockBed.func_22031_a(worldObj, chunkcoordinates.field_22395_a, chunkcoordinates.field_22394_b, chunkcoordinates.field_22396_c, false);
            ChunkCoordinates chunkcoordinates1 = BlockBed.func_22028_g(worldObj, chunkcoordinates.field_22395_a, chunkcoordinates.field_22394_b, chunkcoordinates.field_22396_c, 0);
            setPosition((float)chunkcoordinates1.field_22395_a + 0.5F, (float)chunkcoordinates1.field_22394_b + yOffset + 0.1F, (float)chunkcoordinates1.field_22396_c + 0.5F);
        }
        field_21901_a = false;
    ...
    {
        return worldObj.getBlockId(field_21908_b.field_22395_a, field_21908_b.field_22394_b, field_21908_b.field_22396_c) == Block.field_9262_S.blockID;
    }
    ...
    public float func_22059_J()
    {
        ...
        {
            int i = worldObj.getBlockMetadata(field_21908_b.field_22395_a, field_21908_b.field_22394_b, field_21908_b.field_22396_c);
