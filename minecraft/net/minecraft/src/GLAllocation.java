...
public class GLAllocation
{
    ...
    private static int displayListCounter = 1;
    ...
    {
        // glGenLists is deprecated in OpenGL 4.6 core profile
        // Return a dummy display list ID for compatibility
        int j = displayListCounter++;
    ...
    public static synchronized void deleteTexturesAndDisplayLists()
    {
        ...
        {
            // GL11.glDeleteLists(((Integer)displayLists.get(i)).intValue(), ((Integer)displayLists.get(i + 1)).intValue()); // Deprecated in OpenGL 4.6
        }
