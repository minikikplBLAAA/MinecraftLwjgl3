...
public class ConsoleCommandHandler
{
    ...
    {
        field_22116_b = minecraftserver;
    }

    public void func_22114_a(ServerCommand servercommand)
    {
        ...
        WorldServer worldserver = field_22116_b.worldMngr;
        ServerConfigurationManager serverconfigurationmanager = field_22116_b.configManager;
        ...
        if(s.toLowerCase().startsWith("op "))
        {
            ...
            serverconfigurationmanager.func_22164_e(s2);
        ...
        if(s.toLowerCase().startsWith("deop "))
        {
            ...
            serverconfigurationmanager.func_22165_f(s3);
        ...
        if(s.toLowerCase().startsWith("ban-ip "))
        {
            ...
            serverconfigurationmanager.func_22162_c(s4);
        ...
        if(s.toLowerCase().startsWith("pardon-ip "))
        {
            ...
            serverconfigurationmanager.func_22163_d(s5);
        ...
        if(s.toLowerCase().startsWith("ban "))
        {
            ...
            serverconfigurationmanager.func_22159_a(s6);
            ...
            {
                entityplayermp.field_20908_a.func_43_c("Banned by admin");
            }
        } else
        if(s.toLowerCase().startsWith("pardon "))
        {
            String s7 = s.substring(s.indexOf(" ")).trim();
            serverconfigurationmanager.func_22161_b(s7);
        ...
        if(s.toLowerCase().startsWith("kick "))
        {
            ...
            {
                entityplayermp1.field_20908_a.func_43_c("Kicked by admin");
        ...
        if(s.toLowerCase().startsWith("tp "))
        {
            ...
            if(as.length == 3)
            {
                ...
                {
                    entityplayermp2.field_20908_a.func_41_a(entityplayermp3.posX, entityplayermp3.posY, entityplayermp3.posZ, entityplayermp3.rotationYaw, entityplayermp3.rotationPitch);
        ...
        if(s.toLowerCase().startsWith("time "))
        {
            ...
            try
            {
                ...
                {
                    worldserver.func_22076_a(worldserver.func_22080_k() + (long)j);
        ...
        if(s.toLowerCase().startsWith("say "))
        {
            ...
            field_22117_a.info((new StringBuilder()).append("[").append(s1).append("] ").append(s).toString());
        ...
        if(s.toLowerCase().startsWith("tell "))
        {
            ...
            if(as3.length >= 3)
            {
                s = s.substring(s.indexOf(" ")).trim();
                s = s.substring(s.indexOf(" ")).trim();
                field_22117_a.info((new StringBuilder()).append("[").append(s1).append("->").append(as3[1]).append("] ").append(s).toString());
    ...
    private void func_22113_a(String s, String s1, ICommandListener icommandlistener)
    {
        ...
        if("on".equals(s2))
        {
            ...
            field_22116_b.propertyManagerObj.func_22118_b("white-list", true);
        } else
        if("off".equals(s2))
        {
            func_22115_a(s, "Turned off white-listing");
            field_22116_b.propertyManagerObj.func_22118_b("white-list", false);
        } else
        if("list".equals(s2))
        {
            Set set = field_22116_b.configManager.func_22167_e();
            String s5 = "";
        ...
        if("add".equals(s2) && as.length == 3)
        {
            ...
            field_22116_b.configManager.func_22169_k(s3);
        ...
        if("remove".equals(s2) && as.length == 3)
        {
            ...
            field_22116_b.configManager.func_22170_l(s4);
            func_22115_a(s, (new StringBuilder()).append("Removed ").append(s4).append(" from white-list").toString());
        } else
        if("reload".equals(s2))
        {
            field_22116_b.configManager.func_22171_f();
            func_22115_a(s, "Reloaded white-list from file");
        }
    }

    private void func_22111_a(ICommandListener icommandlistener)
    {
    ...
    private void func_22115_a(String s, String s1)
    {
        ...
        field_22116_b.configManager.sendChatMessageToAllPlayers((new StringBuilder()).append("\2477(").append(s2).append(")").toString());
        field_22117_a.info(s2);
    }

    private int func_22112_a(String s, int i)
    {
        try
        {
