    ...
    public static final int performSpawning(World var0, boolean var1, boolean var2)
    {
        if(!var1 && !var2) {
            ...
            for(int var35 = 0; var35 < var6; ++var35) {
               ...
               if((!var36.func_21103_d() || var2) && (var36.func_21103_d() || var1) && var0.countEntities(var36.getCreatureClass()) <= var36.getMaxNumberOfCreature() * eligibleChunksForSpawning.size() / 256) {
                        ...
                        if(entityliving.getCanSpawnHere())
                        {
                            ...
                            if(pathentity != null && pathentity.pathLength > 1)
                            {
                                ...
                                if(Math.abs((double)pathpoint.xCoord - entityplayer.posX) < 1.5D && Math.abs((double)pathpoint.zCoord - entityplayer.posZ) < 1.5D && Math.abs((double)pathpoint.yCoord - entityplayer.posY) < 1.5D)
                                {
                                    ...
                                    entityliving.setLocationAndAngles((float)chunkcoordinates.field_22216_a + 0.5F, chunkcoordinates.field_529_a, (float)chunkcoordinates.field_528_b + 0.5F, 0.0F, 0.0F);
                                    ...
                                    entityplayer.func_22062_a(true, false);
