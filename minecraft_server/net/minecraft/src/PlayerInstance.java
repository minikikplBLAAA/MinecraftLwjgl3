...
//        super();
    ...
    public void func_779_a(EntityPlayerMP entityplayermp)
    {
        ...
        } else
        {
            ...
            entityplayermp.field_20908_a.sendPacket(new Packet50PreChunk(field_1069_e.chunkXPos, field_1069_e.chunkZPos, true));
    ...
    public void func_778_b(EntityPlayerMP entityplayermp)
    {
        ...
        if(field_1072_b.size() == 0)
        {
            ...
            PlayerManager.getMinecraftServer(field_1073_a).worldMngr.field_20911_y.func_374_c(field_1071_c, field_1070_d);
        }
        entityplayermp.loadedChunks.remove(field_1069_e);
        if(entityplayermp.field_420_ah.contains(field_1069_e))
        {
            entityplayermp.field_20908_a.sendPacket(new Packet50PreChunk(field_1071_c, field_1070_d, false));
        }
    }
        ...
        } else
        {
            ...
            for(int k = 0; k < field_1067_g; k++)
            {
                ...
                if(Block.isBlockContainer[PlayerManager.getMinecraftServer(field_1073_a).worldMngr.getBlockId(j1, i2, k2)])
                {
                    ...
                    func_20178_a(PlayerManager.getMinecraftServer(field_1073_a).worldMngr.getBlockTileEntity(j1, i2, k2));
                }
            }
    ...
    private void func_20178_a(TileEntity tileentity)
    {
        if(tileentity != null)
        {
