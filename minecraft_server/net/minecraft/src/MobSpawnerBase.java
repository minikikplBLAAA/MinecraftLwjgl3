...
public class MobSpawnerBase
{
    ...
    public static final MobSpawnerBase rainforest = (new MobSpawnerRainforest()).setColor(0x8fa36).setBiomeName("Rainforest").func_4080_a(0x1ff458);
    public static final MobSpawnerBase swampland = (new MobSpawnerSwamp()).setColor(0x7f9b2).setBiomeName("Swampland").func_4080_a(0x8baf48);
    public static final MobSpawnerBase seasonalForest = (new MobSpawnerBase()).setColor(0x9be023).setBiomeName("Seasonal Forest");
    public static final MobSpawnerBase forest = (new MobSpawnerForest()).setColor(0x56621).setBiomeName("Forest").func_4080_a(0x4eba31);
    ...
    public static final MobSpawnerBase taiga = (new MobSpawnerTaiga()).setColor(0x2eb153).setBiomeName("Taiga").doesNothingForMobSpawnerBase().func_4080_a(0x7bb731);
    ...
    public static final MobSpawnerBase iceDesert = (new MobSpawnerDesert()).setColor(0xffed93).setBiomeName("Ice Desert").doesNothingForMobSpawnerBase().func_4080_a(0xc4d339);
    public static final MobSpawnerBase tundra = (new MobSpawnerBase()).setColor(0x57ebf9).setBiomeName("Tundra").doesNothingForMobSpawnerBase().func_4080_a(0xc4d339);
