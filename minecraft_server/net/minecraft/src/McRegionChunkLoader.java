    ...
    implements IChunkLoader
{
    ...
    public void saveChunk(World world, Chunk chunk)
    {
        ...
        try
        {
            ...
            WorldInfo worldinfo = world.func_22081_n();
            worldinfo.func_22177_b(worldinfo.func_22182_g() + (long)RegionFileCache.func_22121_b(field_22110_a, chunk.xPosition, chunk.zPosition));
        }
