...
public class NetLoginHandler extends NetHandler
{
    ...
    public void doLogin(Packet1Login packet1login)
    {
        ...
        if(entityplayermp != null)
        {
            ...
            netserverhandler.sendPacket(new Packet6SpawnPosition(chunkcoordinates.field_22216_a, chunkcoordinates.field_529_a, chunkcoordinates.field_528_b));
            ...
            netserverhandler.sendPacket(new Packet4UpdateTime(mcServer.worldMngr.func_22080_k()));
