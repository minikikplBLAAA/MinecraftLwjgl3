...
public class EntityArrow extends Entity
{
    ...
    public void onUpdate()
    {
        ...
        for(int j = 0; j < list.size(); j++)
        {
            ...
            if(!entity1.canBeCollidedWith() || entity1 == field_439_ah && field_437_aj < 5)
            {
                continue;
            }
            float f4 = 0.3F;
        ...
        if(movingobjectposition != null)
        {
            ...
            {
                if(movingobjectposition.entityHit.attackEntityFrom(field_439_ah, 4))
                {
    ...
    public void onCollideWithPlayer(EntityPlayer entityplayer)
    {
        ...
        if(inGround && field_439_ah == entityplayer && arrowShake <= 0 && entityplayer.inventory.addItemStackToInventory(new ItemStack(Item.arrow, 1)))
        {
