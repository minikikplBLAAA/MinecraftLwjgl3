...
public class EntityFish extends Entity
{
    ...
    public void onUpdate()
    {
        ...
        if(!worldObj.multiplayerWorld)
        {
            ...
            {
                if(field_20907_c.isDead)
                {
                    field_20907_c = null;
                } else
                {
                    posX = field_20907_c.posX;
                    posY = field_20907_c.boundingBox.minY + (double)field_20907_c.height * 0.80000000000000004D;
                    posZ = field_20907_c.posZ;
                    return;
                }
            }
        }
        ...
        for(int j = 0; j < list.size(); j++)
        {
            ...
            if(!entity1.canBeCollidedWith() || entity1 == angler && field_4125_al < 5)
            {
                continue;
            }
            float f2 = 0.3F;
        ...
        if(movingobjectposition != null)
        {
            if(movingobjectposition.entityHit != null)
            {
                ...
                {
                    field_20907_c = movingobjectposition.entityHit;
                }
            } else
            {
                field_4129_aj = true;
        ...
        if(d5 > 0.0D)
        {
            ...
            {
                field_4124_am = rand.nextInt(30) + 10;
    ...
    public int func_6143_c()
    {
        ...
        if(field_20907_c != null)
        {
            ...
            field_20907_c.motionX += d * d8;
            field_20907_c.motionY += d2 * d8 + (double)MathHelper.sqrt_double(d6) * 0.080000000000000002D;
            field_20907_c.motionZ += d4 * d8;
            byte0 = 3;
        } else
        if(field_4124_am > 0)
        {
