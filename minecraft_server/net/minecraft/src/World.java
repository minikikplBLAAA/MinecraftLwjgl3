    ...
    implements IBlockAccess
{
    ...
    public World(ISaveHandler isavehandler, String s, long l, WorldProvider worldprovider)
    {
        ...
        savePath = isavehandler.func_22096_c();
        field_9212_p = savePath == null;
        if(worldprovider != null)
        {
            worldProvider = worldprovider;
        } else
        if(savePath != null && savePath.func_22178_h() == -1)
        {
        ...
        if(savePath == null)
        {
            savePath = new WorldInfo(l, s);
            flag = true;
        } else
        {
            savePath.func_22190_a(s);
        }
        ...
        if(flag)
        {
            ...
            savePath.func_22181_a(i, byte0, j);
            field_9209_x = false;
        }
    ...
    {
        checkSessionLock();
        worldFile.func_22095_a(savePath, playerEntities);
    }
    ...
    public void func_22073_e(Entity entity)
    {
        entity.setEntityDead();
        if(entity instanceof EntityPlayer)
        {
    ...
    {
        return worldProvider.calculateCelestialAngle(savePath.func_22186_f(), f);
    }
    ...
    public void func_22074_c(int i, int j, int k, int l, int i1)
    {
        ...
        if(checkChunksExist(i - byte0, j - byte0, k - byte0, i + byte0, j + byte0, k + byte0))
        {
            if(l > 0)
            {
                nextticklistentry.setScheduledTime((long)i1 + savePath.func_22186_f());
            }
    ...
    public void updateEntityWithOptionalForce(Entity entity, boolean flag)
    {
        ...
        if(!entity.addedToChunk || entity.chunkCoordX != k || entity.chunkCoordY != l || entity.chunkCoordZ != i1)
        {
            ...
            {
                getChunkFromChunkCoords(entity.chunkCoordX, entity.chunkCoordZ).func_332_a(entity, entity.chunkCoordY);
            }
            if(chunkExists(k, i1))
            {
    ...
    public void func_21116_a(boolean flag, boolean flag1)
    {
        field_21121_K = flag;
        field_21120_L = flag1;
    }
    ...
    public void func_22077_g()
    {
        ...
        {
            boolean flag = false;
            if(field_21121_K && difficultySetting >= 1)
            {
                flag = SpawnerAnimals.func_22212_a(this, playerEntities);
            }
            if(!flag)
            {
                long l = savePath.func_22186_f() + 24000L;
                savePath.func_22180_a(l - l % 24000L);
                func_22083_p();
            }
        }
        SpawnerAnimals.performSpawning(this, field_21121_K, field_21120_L);
        ...
        long l1 = savePath.func_22186_f() + 1L;
        if(l1 % (long)autosavePeriod == 0L)
        {
            saveWorld(false, null);
        }
        savePath.func_22180_a(l1);
        TickUpdates(false);
        func_4073_g();
    }
    ...
    public boolean TickUpdates(boolean flag)
    {
        ...
        for(int j = 0; j < i; j++)
        {
            ...
            if(!flag && nextticklistentry.scheduledTime > savePath.func_22186_f())
            {
                break;
            }
    ...
    public void func_22076_a(long l)
    {
        savePath.func_22180_a(l);
    }

    public long func_22079_j()
    {
        return savePath.func_22187_b();
    }

    public long func_22080_k()
    {
        return savePath.func_22186_f();
    }

    public ChunkCoordinates func_22078_l()
    {
        return new ChunkCoordinates(savePath.func_22184_c(), savePath.func_22179_d(), savePath.func_22189_e());
    }
    ...
    {
        field_22087_A = !playerEntities.isEmpty();
    ...
    protected void func_22083_p()
    {
        ...
        do
        {
            ...
            if(entityplayer.func_22057_E())
            {
                entityplayer.func_22062_a(false, false);
            }
        } while(true);
    }
    ...
    {
        if(field_22087_A && !multiplayerWorld)
        {
