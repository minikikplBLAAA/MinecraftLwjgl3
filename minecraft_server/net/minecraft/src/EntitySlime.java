    ...
    implements IMobs
{
    ...
    public EntitySlime(World world)
    {
        ...
        yOffset = 0.0F;
        field_402_ae = rand.nextInt(20) + 10;
    ...
    {
        if(slimeSize > 1 && canEntityBeSeen(entityplayer) && (double)getDistanceToEntity(entityplayer) < 0.59999999999999998D * (double)slimeSize && entityplayer.attackEntityFrom(this, slimeSize))
        {
    ...
    public boolean getCanSpawnHere()
    {
        ...
        return (slimeSize == 1 || worldObj.difficultySetting > 0) && rand.nextInt(10) == 0 && chunk.func_334_a(0x3ad8025fL).nextInt(10) == 0 && posY < 16D;
    }
