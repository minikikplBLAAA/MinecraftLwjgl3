...
public class CraftingInventoryWorkbenchCB extends CraftingInventoryCB
{
    ...
    public CraftingInventoryWorkbenchCB(InventoryPlayer inventoryplayer, World world, int i, int j, int k)
    {
        ...
        field_20148_i = j;
        field_20147_j = k;
        func_20122_a(new SlotCrafting(craftMatrix, craftResult, 0, 124, 35));
        for(int l = 0; l < 3; l++)
        {
            for(int k1 = 0; k1 < 3; k1++)
            {
                func_20122_a(new Slot(craftMatrix, k1 + l * 3, 30 + k1 * 18, 17 + l * 18));
            }
        ...
        for(int i1 = 0; i1 < 3; i1++)
        {
            ...
            {
                func_20122_a(new Slot(inventoryplayer, l1 + i1 * 9 + 9, 8 + l1 * 18, 84 + i1 * 18));
            }
        ...
        {
            func_20122_a(new Slot(inventoryplayer, j1, 8 + j1 * 18, 142));
        }
