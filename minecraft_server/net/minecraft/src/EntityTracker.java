...
public class EntityTracker
{
    ...
    public void func_611_a(Entity entity)
    {
        ...
        {
            func_6186_a(entity, 160, 20, true);
        } else
        if(entity instanceof EntityPainting)
        {
            func_6186_a(entity, 160, 0x7fffffff, false);
        }
    }
    ...
    public void func_6186_a(Entity entity, int i, int j, boolean flag)
    {
        ...
        if(field_910_b.containsItem(entity.entityId))
        {
        ...
        } else
        {
            ...
            field_910_b.addKey(entity.entityId, entitytrackerentry);
    ...
    public void func_610_b(Entity entity)
    {
        ...
        EntityTrackerEntry entitytrackerentry = (EntityTrackerEntry)field_910_b.removeObject(entity.entityId);
...
label0:
    ...
    {
        EntityTrackerEntry entitytrackerentry = (EntityTrackerEntry)field_910_b.lookup(entity.entityId);
        if(entitytrackerentry != null)
        {
