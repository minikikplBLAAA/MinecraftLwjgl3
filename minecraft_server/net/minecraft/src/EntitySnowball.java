...
public class EntitySnowball extends Entity
{
    ...
    public void onUpdate()
    {
        ...
        if(!worldObj.multiplayerWorld)
        {
            ...
            for(int l = 0; l < list.size(); l++)
            {
                ...
                if(!entity1.canBeCollidedWith() || entity1 == field_455_ah && field_453_aj < 5)
                {
                    continue;
                }
                float f4 = 0.3F;
        ...
        if(movingobjectposition != null)
        {
            ...
            {
                if(!movingobjectposition.entityHit.attackEntityFrom(field_455_ah, 0));
            }
            for(int j = 0; j < 8; j++)
            {
    ...
    {
        if(inGroundSnowball && field_455_ah == entityplayer && shakeSnowball <= 0 && entityplayer.inventory.addItemStackToInventory(new ItemStack(Item.arrow, 1)))
        {
