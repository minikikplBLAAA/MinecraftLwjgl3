...
public class Item
{
    ...
    public static Item field_22008_aY = (new ItemBed(99)).setMaxStackSize(1).setIconCoord(13, 2).setItemName("bed");
    ...
    static 
    {
        ...
        bucketWater = (new ItemBucket(70, Block.waterStill.blockID)).setIconCoord(11, 4).setItemName("bucketWater").setContainerItem(bucketEmpty);
        bucketLava = (new ItemBucket(71, Block.lavaStill.blockID)).setIconCoord(12, 4).setItemName("bucketLava").setContainerItem(bucketEmpty);
        ...
        field_22007_aZ = (new ItemReed(100, Block.field_22011_bh)).setIconCoord(6, 5).setItemName("diode");
    }
}
