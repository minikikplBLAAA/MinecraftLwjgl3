...
public class CraftingInventoryChestCB extends CraftingInventoryCB
{
    ...
    public CraftingInventoryChestCB(IInventory iinventory, IInventory iinventory1)
    {
        ...
        for(int k = 0; k < i; k++)
        {
            ...
            {
                func_20122_a(new Slot(iinventory1, j1 + k * 9, 8 + j1 * 18, 18 + k * 18));
            }
        ...
        for(int l = 0; l < 3; l++)
        {
            ...
            {
                func_20122_a(new Slot(iinventory, k1 + l * 9 + 9, 8 + k1 * 18, 103 + l * 18 + j));
            }
        ...
        {
            func_20122_a(new Slot(iinventory, i1, 8 + i1 * 18, 161 + j));
        }
