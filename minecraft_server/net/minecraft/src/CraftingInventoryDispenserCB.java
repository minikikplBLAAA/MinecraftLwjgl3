...
public class CraftingInventoryDispenserCB extends CraftingInventoryCB
{
    ...
    public CraftingInventoryDispenserCB(IInventory iinventory, TileEntityDispenser tileentitydispenser)
    {
        ...
        for(int i = 0; i < 3; i++)
        {
            for(int l = 0; l < 3; l++)
            {
                func_20122_a(new Slot(tileentitydispenser, l + i * 3, 61 + l * 18, 17 + i * 18));
            }
        ...
        for(int j = 0; j < 3; j++)
        {
            ...
            {
                func_20122_a(new Slot(iinventory, i1 + j * 9 + 9, 8 + i1 * 18, 84 + j * 18));
            }
        ...
        for(int k = 0; k < 9; k++)
        {
            func_20122_a(new Slot(iinventory, k, 8 + k * 18, 142));
        }
