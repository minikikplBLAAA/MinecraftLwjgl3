    ...
    implements IChunkProvider
{
    ...
    public void func_4061_b(int i, int j, byte abyte0[])
    {
        byte byte0 = 64;
        double d = 0.03125D;
        field_4233_p = field_4237_l.generateNoiseOctaves(field_4233_p, i * 16, j * 16, 0.0D, 16, 16, 1, d, d, 1.0D);
        field_4232_q = field_4237_l.generateNoiseOctaves(field_4232_q, i * 16, 109.0134D, j * 16, 16, 1, 16, d, 1.0D, d);
        field_4231_r = field_4236_m.generateNoiseOctaves(field_4231_r, i * 16, j * 16, 0.0D, 16, 16, 1, d * 2D, d * 2D, d * 2D);
        for(int k = 0; k < 16; k++)
        {
            for(int l = 0; l < 16; l++)
            {
                boolean flag = field_4233_p[k + l * 16] + hellRNG.nextDouble() * 0.20000000000000001D > 0.0D;
                boolean flag1 = field_4232_q[k + l * 16] + hellRNG.nextDouble() * 0.20000000000000001D > 0.0D;
