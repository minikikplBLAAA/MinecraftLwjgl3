...
public class DataWatcher
{
    ...
    private static void writeWatchableObject(DataOutputStream dataoutputstream, WatchableObject watchableobject) throws IOException
    {
        ...
        case 6: // '\006'
            ...
            dataoutputstream.writeInt(chunkcoordinates.field_22216_a);
            dataoutputstream.writeInt(chunkcoordinates.field_529_a);
            dataoutputstream.writeInt(chunkcoordinates.field_528_b);
            break;
        }
    }
